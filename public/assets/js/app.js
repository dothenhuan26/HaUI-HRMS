$(document).ready(function() {
    ...
    $('.form-group-item .btn-add-item').click(function() {
        var groupItems = $(this).
            ...
            find('.group-items');
        let index = $(this).closest('.form-group-item').find('.group-items' +
            ' .item:last-child').data('index');
        ...
        if ($('.group-items .floating').length > 0) {
            $('.floating').on('focus blur', function(e) {
                $(this).
                    parents('.form-focus').
                    toggleClass('focused',
    ...
    if ($('.otp-input, .zipcode-input input, .noborder-input input').length >
        0) {
